                                                        ...
                                                        payment?.status === PaymentStatus.Paid && (
                                                            <div className="space-y-2">
                                                                ...
                                                                <div className="flex items-center gap-x-3">
                                                                    ...
                                                                    <h3 className="text-md font-semibold text-muted-foreground">{payment.method}</h3>
                                                                </div>
                                                                <div className="flex items-center gap-x-3">
                                                                    <div className="shadow-md shadow-primary/80 w-8 h-8 rounded-full flex items-center justify-center">
                                                                ...
                                                                <div className="flex items-center justify-between">
                                                                    ...
                                                                    <Button variant="outline" className="" asChild>
                                                                        <Link href={`/dashboard/finance/monthly?paymentId=${payment.id}`} className="flex items-center gap-x-2">
